...
\titlegraphic{\vspace{-1.95cm}\hspace{-6.25cm}\includegraphics[width=1.5cm]{emblema.eps}}
...
Каждому слову или словосочетанию (терму) $w$ ставится в соответствие некоторое число. В этом случае текст определяется вектором $\vec{u} = (u_1, ..., u_N)^T$,
...
%\textbf{Краткий список использованных источников}\\
%{1.~~}Источник 1.\\
%{2.~~}Источник 2.\\
%\vspace{0.5cm}
