...
\end{enumerate}
{\color{red}\bf To determine $x_i$, the frequency of the term is selected.}
...
Since services require high performance, the C++ language (stl 17, grpc, boost) is chosen as one of the most productive modern languages. For data analysis and training of the {\bf\color{red}AST model}, the Python 3 language and the utouch framework were utilized due to the high efficiency and the possibility of conducting parallel calculations, both on the CPU and on the GPU cores of the machine.
