...
\begin{tikzpicture}
    ...
    \draw [opacity=0.5] (0, -2) node {time in hours};

    \draw [opacity=0.5] (-7.8, 0) node {\rotatebox{90}{request time}};
...
\begin{tikzpicture}
    ...
    \draw [opacity=0.5] (-7.8, 0) node {\rotatebox{90}{request per minute}};
